                    ...
                    <div class="x_panel">
                        <div class="x_title">
                            <form id="form" data-parsley-validate class="form-horizontal form-label-left" method="post" action="">
                                {{csrf_field()}}
                                {{Form::bsTextRequired('title', 'Sayt başlığı', $settings->title)}}
                                {{Form::bsTextRequired('phone', 'Telefon', $settings->phone)}}
                                {{Form::bsEmailRequired('email', 'E-mail', $settings->email)}}
                                {{Form::bsTextRequired('address', 'Ünvan', $settings->address)}}
