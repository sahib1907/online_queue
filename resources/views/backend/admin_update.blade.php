                    ...
                    <div class="x_panel">
                        <div class="x_title">
                            <form id="form" data-parsley-validate class="form-horizontal form-label-left" method="post" action="">
                                {{csrf_field()}}
                                {{Form::bsTextRequired('name', 'Ad', $admin->name)}}
                                {{Form::bsTextRequired('surname', 'Soy Ad', $admin->surname)}}
                                {{Form::bsEmailRequired('email', 'E-mail', $admin->email)}}
                                {{Form::bsPassword('password', 'Şifrə', ['id'=>'password','class'=>'form-control col-md-7 col-xs-12'])}}
