        ...
        <div class="">
            <div class="page-title">
                <div class="title_left">
                    <h3>Sosial şəbəkə düzənləmək</h3>
                </div>
            </div>
                    ...
                    <div class="x_panel">
                        <div class="x_title">
                            <form id="form" data-parsley-validate class="form-horizontal form-label-left" method="post" action="">
                                {{csrf_field()}}
                                {{Form::bsTextRequired('name', 'Ad', $social->name)}}
                                {{Form::bsTextRequired('icon', 'İkon', $social->icon)}}
                                {{Form::bsTextRequired('link', 'Link', $social->link)}}
            ...
            $('form').ajaxForm({
                ...
                success:function (response) {
                    ...
                    if (response.case === 'success') {
                        location.replace('/admin/socials');
                    }
                }
            });
        });
