                    ...
                    <div class="x_panel">
                        <div class="x_title">
                            <form id="form" data-parsley-validate class="form-horizontal form-label-left" method="post" action="">
                                {{csrf_field()}}
                                {{Form::bsTextRequired('name', 'Ad')}}
                                {{Form::bsTextRequired('surname', 'Soy Ad')}}
                                {{Form::bsEmailRequired('email', 'E-mail')}}
                                {{Form::bsPasswordRequired('password', 'Şifrə', ['id'=>'password','class'=>'form-control col-md-7 col-xs-12', 'required'])}}
